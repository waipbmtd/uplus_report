...
# # 惩罚类型
# REPORT_PUNISH_SILENCE = 1
# REPORT_PUNISH_CLOSE_SHOW = 6
# REPORT_PUNISH_DELETE_RESOURCE = 5
# REPORT_PUNISH_LOGIN_LIMIT = 2
# REPORT_PUNISH_DISMISS_GROUP = 3
# REPORT_PUNISH_KICK_OUT_GROUP = 4
